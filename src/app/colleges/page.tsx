...
export default function CollegesPage() {
  ...
  const fetchColleges = useCallback(async (pageNum = 1, reset = false) => {
    setLoading(true);
    ...
    if (reset) {
      ...
      setColleges((prev) => (pageNum === 1 ? data.data : [...prev, ...data.data]));
    }
    setTotal(data.total);
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <aside className="lg:w-64 flex-shrink-0">
          <div className="bg-white rounded-xl border border-gray-200 p-5 sticky top-20">
            ...
            {/* Reset */}
            <button
              onClick={() => { setSearch(""); setType(""); setCategory(""); setMinRating(""); setSortBy("rating"); }}
